...
namespace WebAppForDiplom.Migrations
{
    ...
    [Migration("20220219181724_EditOrderValue1")]
    partial class EditOrderValue1
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebAppForDiplom.Models.UserRole", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<System.Guid>", b =>
                {
                    b.HasOne("WebAppForDiplom.Models.UserRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<System.Guid>", b =>
                {
                    b.HasOne("WebAppForDiplom.Models.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("WebAppForDiplom.Models.Order", b =>
                {
                    b.HasOne("WebAppForDiplom.Models.OrderValue", "OrderValue")
                        .WithMany()
